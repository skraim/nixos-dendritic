...
Item {
    ...
    Item {
        ...
        property string targetText: Notifications.icon
        property color  iconColor: NotificationsService.dnd ? Globals.barColorLow : Globals.barColorNormal
    ...
    MouseArea {
        ...
        onClicked: DashboardService.show(1)
    }
}
